          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <button className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 flex items-center gap-2">
                ...
                <span className="hidden sm:inline" onClick={() => navigate(-1)}>
                  Back to Course
                </span>
              </button>
            </div>
              ...
              <>
                <div className="mb-8">
                  ...
                  <div className="space-y-4 pl-10">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center mt-1">
                        1
                      </div>
                      <p className="text-gray-600 dark:text-gray-400">
                        Definition and purpose of partial fractions
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center mt-1">
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4 text-gray-600 dark:text-gray-400">
                    <p>
                      Partial fraction decomposition is essential for
                      simplifying complex rational expressions. The process
                      involves breaking down a complicated fraction into a sum
                      of simpler fractions, making integration and other
              ...
              <div className="space-y-6 mb-8">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    How do we handle repeated linear factors in partial
                    fractions?
                  </p>
                </div>
              </div>
