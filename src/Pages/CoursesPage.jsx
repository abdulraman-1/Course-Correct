...
import { faPlane, faGear, faComputer, faBook, faCode } from '@fortawesome/free-solid-svg-icons';
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Your Courses</h1>
            <p className="text-gray-600 dark:text-gray-400 text-lg">Explore and manage your enrolled courses</p>
            ...
            <div className="mt-6 max-w-md mx-auto flex gap-4">
              ...
              <button className="px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                <FontAwesomeIcon icon={faFilter} className="text-gray-600 dark:text-gray-300" />
              </button>
            </div>
          </div>
